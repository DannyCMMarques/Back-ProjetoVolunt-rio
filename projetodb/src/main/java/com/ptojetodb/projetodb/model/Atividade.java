...
public class Atividade {
    ...
    @ManyToOne
    @JoinColumn(name = "id_usuario_criador", nullable = false, referencedColumnName = "idUsuario")
    private Usuario usuarioCriador;

    @ManyToOne
    @JoinColumn(name = "id_usuario_convidado", nullable = false, referencedColumnName = "idUsuario")
